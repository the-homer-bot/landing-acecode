...
import { Check, Twitter, Linkedin, Copy, ArrowLeft, Code2 } from 'lucide-react'
    ...
    <main className="min-h-screen bg-gradient-to-b from-background via-background to-black flex items-center justify-center px-4">
      <div className="max-w-lg w-full text-center">
        ...
        >
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3 text-white/60 text-sm">
              ...
              <span>We&apos;ll email you when AceCode is ready</span>
            </li>
            <li className="flex items-start gap-3 text-white/60 text-sm">
              <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
              <span>Waitlist gets first access before public launch</span>
            </li>
            <li className="flex items-start gap-3 text-white/60 text-sm">
              <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <p className="text-white/40 text-sm mb-4">Know other engineers grinding for interviews? Share it!</p>
